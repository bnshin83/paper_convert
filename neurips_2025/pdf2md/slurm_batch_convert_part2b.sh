...
#SBATCH --output=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_part2b.out
#SBATCH --error=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_part2b.err
#SBATCH --exclude=h000,h003

# ============================================
# Batch PDF to Markdown Conversion on H100
# PART 2b: PDFs 2001-2972 (missing range)
# ============================================

echo "========================================="
echo "PDF to Markdown Batch Conversion - PART 2b"
echo "Processing PDFs 2001-2972 (missing range)"
...
echo ""
echo "Starting Marker batch conversion for PART 2b (PDFs 2001-2972)..."
echo ""
...
# PART 2b: PDFs 2001-2972 (0-indexed: 2000-2971)
START_IDX = 2000
END_IDX = 2972
...
print("")
print("=" * 50)
print(f"PART 2b Conversion completed in {elapsed/3600:.2f} hours")
...
if error_list:
    import json
    error_file = output_dir / "errors_part2b.json"
...
echo ""
echo "========================================="
echo "PART 2b Conversion completed"
echo "End time: $(date)"
