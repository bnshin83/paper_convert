...
#SBATCH --output=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_part4r.out
#SBATCH --error=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_part4r.err

# ============================================
# Batch PDF to Markdown Conversion on H100
# PART 4 RETRY: PDFs 3973-4972 (last 1000)
# ============================================

echo "========================================="
echo "PDF to Markdown Batch Conversion - PART 4 RETRY"
...
echo ""
echo "Starting Marker batch conversion for PART 4 RETRY (PDFs 3973-4972)..."
echo ""
...
print("")
print("=" * 50)
print(f"PART 4 RETRY Conversion completed in {elapsed/3600:.2f} hours")
...
if error_list:
    import json
    error_file = output_dir / "errors_part4r.json"
...
echo ""
echo "========================================="
echo "PART 4 RETRY Conversion completed"
echo "End time: $(date)"
