...
#SBATCH --output=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_part3.out
#SBATCH --error=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_part3.err

# ============================================
# Batch PDF to Markdown Conversion on H100
# PART 3: PDFs 2973-3972 (second-last 1000)
# ============================================

echo "========================================="
echo "PDF to Markdown Batch Conversion - PART 3"
echo "Processing PDFs 2973-3972 (second-last 1000)"
...
echo ""
echo "Starting Marker batch conversion for PART 3 (PDFs 2973-3972)..."
echo ""
...
# PART 3: PDFs 2973-3972 (0-indexed: 2972-3971)
START_IDX = 2972
END_IDX = 3972
...
print("")
print("=" * 50)
print(f"PART 3 Conversion completed in {elapsed/3600:.2f} hours")
...
if error_list:
    import json
    error_file = output_dir / "errors_part3.json"
...
echo ""
echo "========================================="
echo "PART 3 Conversion completed"
echo "End time: $(date)"
