...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_cleanup2.out
#SBATCH --error=/scratch/gautschi/shin283/paper/neurips_2025/pdf2md/logs/%j_pdf2md_cleanup2.err
#SBATCH --exclude=h000,h003

# ============================================
# Cleanup job 2: Convert remaining missing PDFs
# Time limit increased to 8 hours
# ============================================

echo "========================================="
echo "PDF to Markdown - CLEANUP 2 (remaining PDFs)"
...
if error_list:
    import json
    error_file = output_dir / "errors_cleanup2.json"
