#!/bin/bash
#SBATCH --job-name=books_pdf2md_1
...
#SBATCH --output=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch1.out
#SBATCH --error=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch1.err
#SBATCH --exclude=h000,h003

# ============================================
# Batch PDF to Markdown Conversion - Batch 1/6
# Books dataset - PDFs 1-14 of 84
# ============================================
