#!/bin/bash
#SBATCH --job-name=books_pdf2md_6
...
#SBATCH --output=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch6.out
#SBATCH --error=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch6.err
#SBATCH --exclude=h000,h003

# ============================================
# Batch PDF to Markdown Conversion - Batch 6/6
# Books dataset - PDFs 71-84 of 84
# ============================================
