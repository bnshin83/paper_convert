#!/bin/bash
#SBATCH --job-name=books_pdf2md_2
...
#SBATCH --output=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch2.out
#SBATCH --error=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch2.err
#SBATCH --exclude=h000,h003

# ============================================
# Batch PDF to Markdown Conversion - Batch 2/6
# Books dataset - PDFs 15-28 of 84
# ============================================
