#!/bin/bash
#SBATCH --job-name=books_pdf2md_5
...
#SBATCH --output=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch5.out
#SBATCH --error=/scratch/gautschi/shin283/paper/others/books/pdf2md/logs/%j_pdf2md_batch5.err
#SBATCH --exclude=h000,h003

# ============================================
# Batch PDF to Markdown Conversion - Batch 5/6
# Books dataset - PDFs 57-70 of 84
# ============================================
