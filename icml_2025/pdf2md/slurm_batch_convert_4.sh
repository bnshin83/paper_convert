#!/bin/bash
#SBATCH --job-name=icml25_pdf2md_4
...
#SBATCH --output=/scratch/gilbreth/shin283/paper_convert/icml_2025/pdf2md/logs/%j_pdf2md_4.out
#SBATCH --error=/scratch/gilbreth/shin283/paper_convert/icml_2025/pdf2md/logs/%j_pdf2md_4.err

# ============================================
# Batch PDF to Markdown Conversion - Part 4/6
