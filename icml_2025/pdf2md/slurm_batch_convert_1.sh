#!/bin/bash
#SBATCH --job-name=icml25_pdf2md_1
...
#SBATCH --output=/scratch/gilbreth/shin283/paper_convert/icml_2025/pdf2md/logs/%j_pdf2md_1.out
#SBATCH --error=/scratch/gilbreth/shin283/paper_convert/icml_2025/pdf2md/logs/%j_pdf2md_1.err

# ============================================
# Batch PDF to Markdown Conversion - Part 1/6
