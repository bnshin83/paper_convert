...
#SBATCH --output=/scratch/gautschi/shin283/paper/icml_2025/pdf2md/logs/%j_pdf2md.out
#SBATCH --error=/scratch/gautschi/shin283/paper/icml_2025/pdf2md/logs/%j_pdf2md.err

# ============================================
# Batch PDF to Markdown Conversion on H100
# ICML 2025 dataset (~3,260 PDFs)
# ============================================
...
# Setup
WORK_DIR="/scratch/gautschi/shin283/paper/icml_2025/pdf2md"
...
# Activate virtual environment (reuse neurips venv)
source /scratch/gautschi/shin283/paper/neurips_2025/pdf2md/.venv/bin/activate

# Configuration
INPUT_DIR="/scratch/gautschi/shin283/paper/icml_2025/pdfs"
...
# Paths
input_dir = Path("/scratch/gautschi/shin283/paper/icml_2025/pdfs")
output_dir = Path("/scratch/gautschi/shin283/paper/icml_2025/pdf2md/markdown_output")
