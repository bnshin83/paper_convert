...
#SBATCH --output=/scratch/gautschi/shin283/paper/iclr_2025/pdf2md/logs/%j_pdf2md.out
#SBATCH --error=/scratch/gautschi/shin283/paper/iclr_2025/pdf2md/logs/%j_pdf2md.err

# ============================================
# Batch PDF to Markdown Conversion on H100
# ICLR 2025 dataset (~3,710 PDFs)
# ============================================
...
# Setup
WORK_DIR="/scratch/gautschi/shin283/paper/iclr_2025/pdf2md"
...
# Configuration
INPUT_DIR="/scratch/gautschi/shin283/paper/iclr_2025/pdfs"
...
input_dir = Path("/scratch/gautschi/shin283/paper/iclr_2025/pdfs")
output_dir = Path("/scratch/gautschi/shin283/paper/iclr_2025/pdf2md/markdown_output")
